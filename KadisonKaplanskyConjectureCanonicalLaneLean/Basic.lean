/-!
# kadison-kaplansky-conjecture-canonical-lane Lean migration boundary
...
`KadisonKaplanskyConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "kadison-kaplansky-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/kadison-kaplansky-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Kadison-Kaplansky conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["k-theory", "mathematical-proof", "operator-algebras", "reproducibility", "c-star-algebras", "group-algebras", "kadison-kaplansky-conjecture", "canonical-lane", "local-to-global", "manifold-constrained"]
